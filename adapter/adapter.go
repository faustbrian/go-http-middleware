...
func (e *OwnershipError) Error() string {
	return fmt.Sprintf("adapter: %s is installed by both go-service and the explicit chain", e.Concern)
}
...
// go-service default server stack. Callers must validate before combining it
...
// selected go-service configuration owns.
